    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assesmentskill_name', models.CharField(max_length=255, unique=True, verbose_name='Название оценки')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competency_type', models.CharField(choices=[('hard', 'Hard'), ('soft', 'Soft')], default=core.models.SkillTypeEnum['HARD'], max_length=100, verbose_name='Тип компетенции')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee_id', models.CharField(default=uuid.uuid4, editable=False, max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill_type', models.CharField(choices=[('hard', 'Hard'), ('soft', 'Soft')], default=core.models.SkillTypeEnum['HARD'], max_length=4, verbose_name='Тип навыка')),
                ('employee_count', models.IntegerField(default=0, verbose_name='Количество сотрудников с данным навыком')),
            ],
            options={
                'verbose_name': 'Навык',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=255, unique=True, verbose_name='Слаг команды')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='training_applications', to='core.employee')),
                ('training_application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.trainingapplication', verbose_name='Заявка на обучение')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee', models.ManyToManyField(related_name='teams', to='core.employee')),
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teams', to=settings.AUTH_USER_MODEL, verbose_name='Менеджер команды')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('skill_level', models.IntegerField(default=0, verbose_name='Уровень навыка сотрудника')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skills', to='core.employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='positions', to='core.employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='key_skills', to='core.employee')),
                ('key_skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.keyskill', verbose_name='Ключевой навык')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='keys_people', to='core.employee')),
                ('key_people', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.keypeople', verbose_name='Key people')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='grades', to='core.employee')),
                ('grade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.grade', verbose_name='Класс')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expected_skills', to='core.employee')),
                ('expected_skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.expectedskill', verbose_name='Ожидаемый навык')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('performance_score', models.IntegerField(verbose_name='Уровень вовлеченности сотрудника')),
                ('add_date', models.DateField(auto_now_add=True, db_index=True, verbose_name='Дата вовлечения сотрудника')),
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='employee_engagements', to='core.employee')),
                ('engagement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.engagement', verbose_name='Вовлеченность')),
            ],
            options={
                'verbose_name': 'Вовлеченность сотрудника',
                'verbose_name_plural': 'Вовлеченность сотрудников',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('performance_score', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Процент развития')),
                ('add_date', models.DateField(auto_now_add=True, db_index=True, verbose_name='Дата добавления сотрудника в план развития')),
                ('development_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.developmentplan', verbose_name='План развития')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='development_plans', to='core.employee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('planned_result', models.FloatField(default=0.0, verbose_name='Плановая оценка')),
                ('actual_result', models.FloatField(default=0.0, verbose_name='Фактическая оценка')),
                ('competency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.competency', verbose_name='Компетенция')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_competencies', to='core.employee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bus_factor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.busfactor', verbose_name='Bus фактор')),
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='bus_factors', to='core.employee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('assesment', models.IntegerField(default=0, verbose_name='Оценка навыка сотрудника')),
                ('assesmentskill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.assesmentskill', verbose_name='Оценка навыка сотрудника')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assesments_skills', to='core.employee')),
            ],
            options={
